...
if __name__ == "__main__":
    ...
    # (Histogram plotting has been moved to src/plot_results.py)

    # (Histogram plotting has been moved to src/plot_results.py)

    # ==================== Task 4: Differentiable MLA-ROBD train-time fusion (paper setting) ====================
    print("\n" + "="*60)
    ...
    # Default parameters from the paper (no search). λ2 comes from the global setting above
    la1_train = 0.5
    theta = 0.5
